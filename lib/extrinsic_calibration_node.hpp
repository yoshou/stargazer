...
class extrinsic_calibration_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "extrinsic_calibration"; }
...
COALSACK_REGISTER_NODE(stargazer::extrinsic_calibration_node, coalsack::graph_node)
